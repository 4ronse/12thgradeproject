...
class FSEntry {
    ...
    getDiv() {
        ...
        container.classList.add('item', 'col-md-3', 'col-sm-6', 'my-2');
        card.classList.add('card');
        cardBody.classList.add('card-body');
        image.classList.add('card-img-top');
        textContainer.classList.add('row', 'mt-2');
        span.classList.add('card-text');

        // card.style.minWidth = '18rem';
        image.style.height = '12rem';
        textContainer.style.minHeight = '1rem !important';
...
class File extends FSEntry {
    ...
    getDiv() {
        let div = super.getDiv();
        div.setAttribute('data-hashed-file-name', this.SHA256);
        return div;
    }
